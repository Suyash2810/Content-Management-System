                                        ...
                                        <?php
                                           ...
                                           ?>
                                                <p class="text-center">
                                                    ...
                                                    <?php $sub_id = get_onePgae_by_id($clicked_page_id);?>
                                                    <h3 class="text-center"><a style="text-decoration:none;color:white;"
                                                href="edit_page.php?subject=<?php echo urlencode($sub_id["subject_id"]);?>&page=<?php echo urlencode($clicked_page_id);?>"> ->  Edit a page for the subject.</a></h3>
